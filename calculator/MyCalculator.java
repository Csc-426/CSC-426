...
// myCalculator: a CSC426 desktop calculator built with Java Swing.
// The whole expression you type is shown in the display, and the answer is
// added after you press = (for example 2+4-93=-87). Supports + - * / \ ^ %
...
public class MyCalculator extends JFrame {
    ...
    // warm light palette
    private static final Color FRAME_BG  = new Color(0xFA, 0xF6, 0xF0);
    private static final Color SURFACE   = Color.WHITE;
    private static final Color BORDER    = new Color(0xE3, 0xD8, 0xC9);
    private static final Color TEXT      = new Color(0x2A, 0x23, 0x20);
    private static final Color MUTED     = new Color(0x7A, 0x6F, 0x64);
    private static final Color OP_BG     = new Color(0xFD, 0xEE, 0xDE);
    private static final Color OP_TEXT   = new Color(0xC2, 0x41, 0x0C);
    private static final Color FUNC_BG   = new Color(0xF2, 0xEC, 0xE4);
    private static final Color EQ_BG     = new Color(0xEA, 0x58, 0x0C);
    ...
    public static void main(String[] args) {
        if (args.length > 0 && args[0].equals("--test")) {
            for (String t : new String[]{"2+4-93", "2+3*4", "2^3^2", "7\\2", "10%3", "-5+2"})
